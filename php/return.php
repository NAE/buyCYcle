<?php
	...
	$qry = $db->prepare("SELECT slotnum FROM Slots WHERE rackid='".$currentRack."' AND hasbike=0 LIMIT 1;");
	$qry->execute();
...
<body>
	...
	<span id="bikelabel" class="label label-danger">Please return bike!</span>
